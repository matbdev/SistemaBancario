...
public class TelaDeletarUsuario extends javax.swing.JDialog {
     ...
     */
    public TelaDeletarUsuario(JFrame parent, IDao<Pessoa, CPF> cdao, ArrayList<Pessoa> al) {
        super(parent, "Remoção de Correntista", true);
        this.cdao = cdao;
    ...
    private void botaoCadastroActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            this.labelSuccessError.setText("<html>Erro: Correntista não encontrado para deletar.</html>");
