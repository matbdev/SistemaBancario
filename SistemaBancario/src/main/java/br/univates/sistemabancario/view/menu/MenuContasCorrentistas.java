...
public class MenuContasCorrentistas extends MenuDialog {
     ...
     */
    public MenuContasCorrentistas(CorrentistaDAO cdao, ContaBancariaDAO cbdao, DataBaseConnectionManager db) {
        super(null, true);
    ...
    private void adicionarOpcoes() {
        ...
        addOption("Contas Bancárias", () -> {
            SwingUtilities.invokeLater(() -> {
                MenuContasBancarias mcb = new MenuContasBancarias(this.cdao, this.cbdao, this.db);
                mcb.exibir();
            });
        });
