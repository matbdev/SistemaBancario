...
public class TelaEditarUsuario extends javax.swing.JDialog {
         ...
         */
        public TelaEditarUsuario(JFrame parent, IDao<Pessoa, CPF> cdao) {
                super(parent, "Edição de Correntista", true); // Título corrigido
                this.cdao = cdao;
        ...
        private void botaoCadastroActionPerformed(@SuppressWarnings("unused") java.awt.event.ActionEvent evt) {
                try {
                        ...
                        this.cbCorrentista.carregarCorrentistas(pAtualizada);

                } catch (CpfInvalidoException e) {
                        this.labelSuccessError
                                        .setText("<html>Erro: O CPF é inválido (isso não deveria acontecer).</html>");
                        this.labelSuccessError.setForeground(Color.red);
                } catch (RecordNotFoundException e) {
                        this.labelSuccessError.setText("<html>Erro: Correntista não encontrado para atualizar.</html>");
                        this.labelSuccessError.setForeground(Color.red);
